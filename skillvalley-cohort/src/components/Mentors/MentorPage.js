  ...
  return (
    <div className='Mbackground'>
      ...
      <p id='mbcp'>For any guidance you can connect with mentors via LinkedIn or Twitter</p>
         ...
         <Cards name="Jeff Hammerbacher" imgUrl={img3} prof="Domain: Data Analysis" skills="Skills: Python, R, Tableu" lkdn="https://www.linkedin.com/in/jhammerb/" twtr="https://twitter.com/hackingdata" />
